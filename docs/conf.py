...
latex_documents = [
    (master_doc, 'cellsino.tex', 'cellsino Documentation',
     'Paul Müller', 'manual'),
]
...
man_pages = [
    (master_doc, 'cellsino', 'cellsino Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cellsino', 'cellsino Documentation',
     author, 'cellsino', 'generate sinograms of cell phantoms',
     'Scientific'),
]
